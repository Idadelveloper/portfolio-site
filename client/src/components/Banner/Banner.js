            ...
            <div className="banner" >
                ...
                <div className="">
                    ...
                    <div className="intro mx-5">
                        <p className="home-greeting">Hello 👋, I'm happy you found me. I'm currently a computer engineering student and developer based in Cameroon. Just a nerd that enjoys coding and loves customizing her development environment. I'm interested in devising better problem-solving methods to solve challenging tasks, and learning new technologies and tools when the need arises.</p>
                    </div>
